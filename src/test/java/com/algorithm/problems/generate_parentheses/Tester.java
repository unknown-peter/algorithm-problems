...
//        solution = new Solution1();
    ...
    private List<String> expected;                    // parameter 2 (expected answer)
    ...
    public void test() {
        ...
        Object actual = solution.generateParenthesis(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("generateParenthesis() pass unit test!");
        }
    }
