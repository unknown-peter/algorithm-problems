...
//        solution = new Solution1();
    ...
    public void test() {
        ...
        Object actual = TreeNodeConvertClass.treeNodeToString(
                solution.invertTree(TreeNodeConvertClass.stringToTreeNode(para1)));

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("invertTree() pass unit test!");
        }
    }
