...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new String[]{"RecentCounter", "ping", "ping", "ping", "ping"},
                        new int[][]{new int[]{}, new int[]{1}, new int[]{100}, new int[]{3001}, new int[]{3002}},
    ...
    public void test() {
        ...
        Object actual = solution.recentCounterOperate(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("recentCounterOperate() pass unit test!");
        }
    }
