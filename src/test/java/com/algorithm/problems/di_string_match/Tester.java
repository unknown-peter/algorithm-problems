...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {"III", new int[]{0, 1, 2, 3}},
                {"DDI", new int[]{3, 2, 0, 1}},
                {"IDIDIIIDDDIDIDIDD", new int[]{0, 17, 1, 16, 2, 3, 4, 15, 14, 13, 5, 12, 6, 11, 7, 10, 9, 8}}
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.diStringMatch(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("diStringMatch() pass unit test!");
        }
    }
