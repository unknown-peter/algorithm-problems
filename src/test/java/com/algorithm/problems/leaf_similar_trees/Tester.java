...
//        solution = new Solution2();
    ...
    public void test() {
        ...
        Object actual = solution.leafSimilar(TreeNodeConvertClass.stringToTreeNode(para1), TreeNodeConvertClass.stringToTreeNode(para2));

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("leafSimilar() pass unit test!");
        }
    }
