...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {"[]", 0, false},
                {"[-2,null,-3]", -5, true},
                {"[9,6,-3,null,null,-6,2,null,null,2,null,-6,-6,-6]", 4, true},
                {"[-1,null,9,-6,3,null,null,null,-2]", 9, true}
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.hasPathSum(TreeNodeConvertClass.stringToTreeNode(para1), para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("hasPathSum() pass unit test!");
        }
    }
