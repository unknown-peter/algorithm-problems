...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new String[]{"MyHashMap", "put", "put", "get", "get", "put", "get", "remove", "get"},
                        new int[][]{{}, {1, 1}, {2, 2}, {1}, {3}, {2, 1}, {2}, {2}, {2}}, new Integer[]{null, null, null, 1, -1, null, 1, null, -1}}
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.hashmapOperate(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("hashmapOperate() pass unit test!");
        }
    }
