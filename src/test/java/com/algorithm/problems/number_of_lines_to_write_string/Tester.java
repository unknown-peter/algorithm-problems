...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
                        "abcdefghijklmnopqrst", new int[]{2, 100}},
                {new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
                        "abcdef", new int[]{1, 60}}
        });
    }
     ...
     */
    public Tester(int[] para1, String para2, int[] expected) {
    ...
    public void test() {
        ...
        Object actual = solution.numberOfLines(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("numberOfLines() pass unit test!");
        }
    }
