...
public class Tester {
    ...
    private double para2;                       // parameter 2
    private int expected;                    // parameter 3 (expected answer)

    /**
     * This constructor must be provided to run parameterized test.
     */
    public Tester(String para1, double para2, int expected) {
    ...
    public void test() {
        ...
        Object actual = solution.closestValue(TreeNodeConvertClass.stringToTreeNode(para1), para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("closestValue() pass unit test!");
        }
    }
