...
//        solution = new Solution1();
    ...
    private boolean expected;                    // parameter 2 (expected answer)
    ...
    public void test() {
        ...
        Object actual = solution.isUnivalTree(TreeNodeConvertClass.stringToTreeNode(para1));

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("isUnivalTree() pass unit test!");
        }
    }
