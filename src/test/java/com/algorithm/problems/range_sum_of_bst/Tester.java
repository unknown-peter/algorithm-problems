...
//        solution = new Solution1();
     ...
     */
    public Tester(String para1, int para2, int para3, int expected) {
    ...
    public void test() {
        ...
        Object actual = solution.rangeSumBST(TreeNodeConvertClass.stringToTreeNode(para1), para2, para3);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("rangeSumBST() pass unit test!");
        }
    }
