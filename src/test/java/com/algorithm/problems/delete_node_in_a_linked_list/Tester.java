...
public class Tester {
    ...
    public void test() {
        ...
        ListNode node = ListNodeConvertClass.stringToListNode(para1);
        solution.deleteNode(ListNodeConvertClass.getNode(node, para2));

        assertThat(ListNodeConvertClass.listNodeToString(node), is(equalTo(expected)));
