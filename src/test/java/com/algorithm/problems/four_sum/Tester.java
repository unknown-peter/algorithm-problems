...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][] {
                {new int[] {1, 0, -1, 0, -2, 2}, 0,
                        Arrays.asList(Arrays.asList(-2, -1, 1, 2), Arrays.asList(-2, 0, 0, 2),
                                Arrays.asList(-1, 0, 0, 1))},
                {new int[] {2, 2, 2, 2, 2}, 8, Arrays.asList(Arrays.asList(2, 2, 2, 2))},
                {new int[] {1000000000, 1000000000, 1000000000, 1000000000}, -294967296, Arrays.asList()},
        });
    }
    ...
    public void test() {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("fourSum() pass unit test!");
        }
    }
