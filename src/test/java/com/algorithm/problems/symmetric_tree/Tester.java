...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{{"[1,2,2,3,4,4,3]", true}, {"[1,2,2,3,4,3,4]", false},
                {"[1,2,2,null,3,null,3]", false}, {"[2,3,3,4,5,5]", false}});
    }
    ...
    public void test() {
        ...
        Object actual = solution.isSymmetric(ConvertClass.stringToTreeNode(para1));
