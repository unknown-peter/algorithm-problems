...
public class Tester {
     ...
     */
    public Tester(String para1, String para2, char expected) {
    ...
    public void test() {
        ...
        Object actual = solution.findTheDifference(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("findTheDifference() pass unit test!");
        }
    }
