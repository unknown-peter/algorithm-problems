...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {"[1,2,null,3,4,null,null,5]", 2, 4, false},
     ...
     */
    public Tester(String para1, int para2, int para3, boolean expected) {
    ...
    public void test() {
        ...
        Object actual = solution.isCousins(TreeNodeConvertClass.stringToTreeNode(para1), para2, para3);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("isCousins() pass unit test!");
        }
    }
