...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {new int[]{1, 2, 3, 4}, new int[]{5, 6}, 2},
                {new int[]{1, 3, 7}, new int[]{5, 8}, 2},
                {new int[]{1, 3, 9}, new int[]{5, 8}, 2},
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.findContentChildren(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("findContentChildren() pass unit test!");
        }
    }
