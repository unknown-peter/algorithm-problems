...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new int[][]{new int[]{0, 30}, new int[]{5, 10}, new int[]{15, 20}}, false},
                {new int[][]{new int[]{7, 10}, new int[]{2, 4}}, true}
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.canAttendMeetings(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("canAttendMeetings() pass unit test!");
        }
    }
