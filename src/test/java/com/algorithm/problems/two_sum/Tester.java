...
import com.algorithm.problems.two_sum.Solution;
import com.algorithm.problems.two_sum.Solution3;
...
public class Tester {
    ...
    /**
     * Parameters for each test (initialized in testcases() method) You can change the type of
     * parameters
     */
