...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new int[]{12, 28, 46, 32, 50}, new int[]{50, 12, 32, 46, 28}, new int[]{1, 4, 3, 2, 0}}
        });
    }
    ...
    public void test() {
        ...
        Object actual = solution.anagramMappings(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("anagramMappings() pass unit test!");
        }
    }
